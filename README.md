go-chart
========
[![CircleCI](https://circleci.com/gh/wcharczuk/go-chart.svg?style=svg)](https://circleci.com/gh/wcharczuk/go-chart) [![Go Report Card](https://goreportcard.com/badge/github.com/liuxhu/go-chart)](https://goreportcard.com/report/github.com/liuxhu/go-chart)
...
```bash
> go get -u github.com/liuxhu/go-chart
```
...
import (
    ...
    "bytes"
    ...
    "github.com/liuxhu/go-chart" //exposes "chart"
)
